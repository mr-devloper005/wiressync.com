...
const taskTitles: Record<TaskKey, string[]> = {
  ...
  mediaDistribution: [
    "Company Announces Strategic Expansion",
    "New Industry Partnership Goes Live",
    "Media Desk Shares Quarterly Update",
    "Public Launch Introduces New Service",
    "Newswire Briefing Highlights Growth",
  ],
  article: [
...
const taskCategories: Record<TaskKey, string[]> = {
  ...
  mediaDistribution: ["News Media", "Business", "Technology", "Press Release", "Public Relations"],
...
const summaryByTask: Record<TaskKey, string> = {
  ...
  mediaDistribution: "A newsroom-style update distributed for public discovery.",
