...
export function EditableFooter() {
  ...
  return (
    <footer className="border-t-8 border-[var(--slot4-accent)] bg-black text-white">
      <div className="mx-auto max-w-[var(--editable-container)] px-4 py-14 sm:px-6 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_.7fr_.7fr]">
          <div>
            ...
            <form action="/signup" className="mt-8 flex max-w-xl border border-white/35">
              ...
              <button className="bg-[var(--slot4-accent)] px-5 text-xs font-black uppercase tracking-[.14em] transition hover:bg-white hover:text-black">Join</button>
            </form>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3">
              ...
              {session ? (
                <>
                  <Link href="/create" className="text-sm font-black uppercase tracking-[.08em] hover:text-[var(--slot4-accent)]">{session.name}</Link>
