...
export const taskPageMetadata: Record<TaskKey, { title: string; description: string }> = {
  mediaDistribution: {
    title: 'Media distribution and newsroom updates',
    description: 'Browse announcements, press coverage, company updates, and distributed media across every active category.',
  },
  article: {
...
> = {
  ...
  mediaDistribution: {
    title: 'Newsroom updates, announcements, and distributed media',
    paragraphs: [
      'Browse public updates, media coverage, company announcements, and newsroom-style posts across categories controlled by the master panel.',
      'New categories are accepted automatically, so every site can adapt without a code deployment.',
      'Each update connects source information, visual media, and related coverage through a clean publishing experience.',
    ],
    links: [],
  },
  article: {
